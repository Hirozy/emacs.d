...
(global-set-key
 ...
 (defhydra hydra-high-frequency (:foreign-keys warn :exit t)
   ("c" counsel-buffer-or-recentf "recent file" :column "Navigate")
   ("C" counsel-bookmark "bookmark")
   ("b" counsel-projectile-switch-to-buffer "project buffer")
   ...
   ("i" counsel-semantic-or-imenu "semantic imenu")
